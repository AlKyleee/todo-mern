  ...
  return (
    <div className="App">
      ...
      <form className='form' onSubmit={e => addItem(e)}>
        <input type="text" placeholder='Item Name' onChange={e => {setItemName(e.target.value)}} value={itemName} required />
        <input type="text" placeholder='Item Price' onChange={e => {setItemPrice(e.target.value)}} value={itemPrice} required />
        <input type="number" placeholder='Item Quantity' onChange={e => {setItemQuantity(e.target.value)}} value={itemQuantity} min="0" required />
